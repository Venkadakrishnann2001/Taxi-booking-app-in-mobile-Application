    ...
    if (!emailError && !passwordError) {
      try {
        ...
        if (response.ok) {
          ...
          navigation.navigate('PhotoTable'); // Replace 'NextPage' with your actual page name
        } else {
    ...
    <View className="flex-1 bg-white" style={{ backgroundColor: themeColors.bg }}>
      <SafeAreaView className="flex">
        ...
        <View className="flex-row justify-center">
          <Image source={require('../assets/images/car1.jpg')} style={{ width: 300, height: 250 }} />
        </View>
      </SafeAreaView>
      <View style={{ borderTopLeftRadius: 50, borderTopRightRadius: 50 }} className="flex-1 bg-white px-8 pt-8">
        ...
        <View className="flex-row justify-center mt-7">
          ...
          <TouchableOpacity onPress={() => navigation.navigate('PhotoTable')}>
            <Text className="font-semibold text-yellow-500"> PhotoTable</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
