  ...
  const handleAdmin = async () => {
    ...
    if (Object.keys(errors).length === 0) {
      try {
        ...
        const response = await fetch('http://192.168.43.81:8000/api/admin/register', {
          method: 'POST',
          headers: {
  ...
  return (
    ...
    >
      <View className="form space-y-2">
        ...
        <TouchableOpacity
  onPress={handleAdmin} // This is where the navigation occurs
...
>
  <Text className="font-xl font-bold text-center text-gray-700">
    ...
    // Your JSX for the signup screen...
  );
}
